...
//        avcEncoder.offerEncoder(frame);
//        Log.i(TAG, "每帧回调");
//
//        Camera.Size size = mCamera.getParameters().getPreviewSize();
//        try {
//            // 调用image.compressToJpeg（）将YUV格式图像数据data转为jpg格式
//            YuvImage image = new YuvImage(frame, ImageFormat.NV21, size.width,
//                    size.height, null);
//            if (image != null) {
...
//                // 启用线程将图像数据发送出去
//                Thread th = new MyThread(outstream.toByteArray(), "192.168.43.79");
//                th.start();
//            }
//        } catch (Exception ex) {
...
//        }
    ...
    public void startGoogleFaceDetect(FaceDetect faceDetect){
